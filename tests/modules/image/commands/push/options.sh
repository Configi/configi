...
# Created: Wed 13 Mar 2019 04:53:22 AM UTC
#
#/ usage: image:push  --arg <> [ --comment <>] [ --verbose <>] [ --register <>] [ --requires <>]  --host <> [ --unsigned <false>]  --image <> [ --changelog <>] 
...
rerun_options_parse() {
    ...
    do
        ...
        case "$OPT" in
            ...
            --changelog) rerun_option_check $# $1; CHANGELOG=$2 ; shift 2 ;;
            # help option
            -\?|--help)
                rerun_option_usage
                exit 2
