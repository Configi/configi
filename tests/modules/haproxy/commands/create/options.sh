...
# Created: Wed 13 Mar 2019 01:17:34 PM UTC
#
#/ usage: haproxy:create  --arg <> [ --comment <>] [ --verbose <>] [ --register <>] [ --requires <>]  --config <> 
...
rerun_options_parse() {
    ...
    [[ -z "$CONFIG" ]] && { echo >&2 "missing required option: --config" ; return 2 ; }
