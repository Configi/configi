...
# Created: Wed 13 Mar 2019 05:21:32 PM UTC
#
#/ usage: oneshot:service  --arg <> [ --comment <>] [ --verbose <>] [ --register <>] [ --requires <>]  --name <>  --start <>  --stop <> 
...
rerun_options_parse() {
    ...
    do
        ...
        case "$OPT" in
            ...
            --start) rerun_option_check $# $1; START=$2 ; shift 2 ;;
            --stop) rerun_option_check $# $1; STOP=$2 ; shift 2 ;;
            # help option
            -\?|--help)
                rerun_option_usage
                exit 2
    ...
    [[ -z "$START" ]] && { echo >&2 "missing required option: --start" ; return 2 ; }
    [[ -z "$STOP" ]] && { echo >&2 "missing required option: --stop" ; return 2 ; }
